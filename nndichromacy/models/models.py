...
from .cores import SE2dCore, TransferLearningCore, GaussianLaplaceCore, SE2dCorePositive
from .readouts import (
    ...
    MultipleCenterSurround,MultipleCenterSurroundDoG,
...
def se_core_center_surround_dog(
        dataloaders,
        seed,
        hidden_channels=32,
        input_kern=13,  # core args
    ...
    """
    Model class of a stacked2dCore (from neuralpredictors) and a center_surround (spatial transformer) readout
    consider center as gaussian and surround as difference of gaussian
    Args:
        dataloaders: a dictionary of dataloaders, one loader per session
            in the format {'data_key': dataloader object, .. }
        seed: random seed
    ...
    readout = MultipleCenterSurroundDoG(
        core,
        in_shape_dict=in_shapes_dict,
        n_neurons_dict=n_neurons_dict,
        bias=readout_bias,
